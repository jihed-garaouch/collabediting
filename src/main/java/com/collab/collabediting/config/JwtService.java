...
public class JwtService {
    ...
    private  static  final String SECRET_KEY="3361383970474E4946497649766347336A655446775250675171717746433576" ;
    ...
    private Key getSignInKey() {
        byte[] keyBytels= Decoders.BASE64.decode(SECRET_KEY);
        return Keys.hmacShaKeyFor(keyBytels);
