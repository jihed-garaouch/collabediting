...
public  class GithubBaseClient<T extends  Object> implements IGithubBaseClient<T> {
    ...
    public <U> U get(TypeReference<U> typeReference,String path) throws IOException, InterruptedException, RuntimeException {
    ...
    public <U> List<U> getList(  TypeReference<List<U>> typeReference,String path) throws IOException, InterruptedException, RuntimeException {
        URI newUri = uri.resolve(path);
        HttpRequest request= HttpRequest.newBuilder()
                .uri(newUri)
                .header("Authorization","Bearer "+getAccessToken())
    ...
    public boolean post( T body, String path) throws IOException, InterruptedException {
        URI newUri = uri.resolve(path);
        String jsonBody = jsonMapper.writeValueAsString(body);
        HttpRequest request =HttpRequest.newBuilder()
                .uri(uri)
    ...
    public boolean put(T body,String path) throws IOException, InterruptedException {
        URI newUri = uri.resolve(path);
        String jsonBody = jsonMapper.writeValueAsString(body);
        HttpRequest request =HttpRequest.newBuilder()
                .uri(uri)
